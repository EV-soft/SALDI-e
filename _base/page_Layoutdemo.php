<?php   $DocFil= '../_base/page_Layoutdemo.php';    $DocVer='5.0.0';    $DocRev='2017-10-00';   $DocIni='evs';  $ModulNr=0;
 ...
 */
  ...
  include("../_base/htm_pageHead.php"); # Sidens indledende html-kode, samt almen initiering
