<?php   $DocFil= '../_system/page_Ordrerelat.php';    $DocVer='5.0.0';    $DocRev='2018-09-20';   $DocIni='evs';  $ModulNr=0;
/* ## Purpose: 'Redigering af Ordrerelateret';
...
### VIS DATA:
    ...
    NextSpalte(640);  Panl_Ordrerelat($xx);
    SpalteBund();
### GEM DATA:
