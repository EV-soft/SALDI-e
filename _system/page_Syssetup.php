<?php   $DocFil= '../_base/_admin/page_Syssetup.php';   $DocVer='5.0.0';   $DocRev='2017-03-00';   $modulnr=99;
...
### INDLÆS DATA:
  if (!file_exists("../_config/connect.php"))  {    //  include("../base/page_LayoutModuler.php"); exit;
...
//  echo '['.$adm_password.'] '.$adm_passcryp;
...
### VIS DATA:
  ...
  NextSpalte();   Rude_DBsetup($db_type='MySQL',$db_encode,$db_navn,$db_bruger,$db_password,$adm_navn,$adm_password,$verify_adm_password);
  SpalteBund();   
  skilleLin();
